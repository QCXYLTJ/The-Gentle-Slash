...
const translate1 = {
    ...
    轩辕剑: '轩辕剑',
    轩辕剑_info: '当你使用杀指定目标时,阳:你令目标回复一点体力增加一个剑标记,然后摸三张牌令此杀失效;阴:你可以额外指定攻击范围内两名目标,并对目标造成x点伤害(x为目标角色剑标记数)',
    神农鼎: '神农鼎',
    ...
    南蛮_info: '南蛮',
    三窟: '三窟',
    三窟_info: '当你进入濒死状态时,你减1点体力上限,然后将体力回复至体力上限',
    连营: '连营',
    ...
    冯河: '冯河',
    冯河_info: '当你受到伤害时,你防止之,然后若此伤害有来源且来源不是你,你与伤害来源各减一点体力上限',
    杀: '杀',
    ...
    QQQ_xipai: '万物源气',
    QQQ_xipai_info: '当你体力变化/不因使用失去牌/死亡时,取消之,然后移除牌堆顶X张牌(X为此次事件的数值).牌堆洗牌后,你死亡',
    御策: '御策',
    御策_info: '你受到伤害后,除非来源弃置三种不同类型的牌,否则你回复一点体力',
    无矩: '无矩',
    无矩_info: '你使用手牌结算后,重铸所有手牌并摸一张牌,然后你可以令其中任意张牌本回合无法被重铸.当你通过技能弃置的牌数超过x!时,你减一点体力上限,摸两张牌并清空弃牌记录.(x为你发动此技能的次数)',
    全装备: '全装备',
    全装备_info: '开局铠甲合体',
    自伤: '自伤',
