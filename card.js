...
const translate3 = {
    ...
    轩辕剑: '轩辕剑',
    轩辕剑_info: '当你使用杀指定目标时,阳:你令其回复一点体力,令此杀失效,你摸三张牌;阴:你可以额外指定两名目标,对目标之一造成一点伤害',
    神农鼎: '神农鼎',
    神农鼎_info: '改变你桃的作用,改为可以回血超过上限且回复效果两倍且获得两点护甲.当有角色使用桃后,你摸一张牌.回合限一次,你可以将一张牌当桃使用',
    伏羲琴: '伏羲琴',
